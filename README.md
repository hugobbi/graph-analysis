...
# Execuções:
	...
	Não mostra vértices com degree menor ou igual a: 0
	
    2)  > $ python3 main.py -atb 4 5 -id 1 2 -rst 7 -lim 0.1 -f "meu_arquivo.csv" -o -ni -raw -m "degree" "eigenvector_centrality" -mdeg 1
	...
	Não mostra vértices com degree menor ou igual a: 1
...
# Sobre os parâmetros:
    ...
    -raw : Determina se o grafo usado para tomar as medidas inclui vértices que não formam nenhuma aresta. Por padrão, o programa remove os vértices de grau zero do grafo. Com esta opção, o programa usará o grafo sem remover estes vértices.
    ...
    -norm : Determina se o programa normaliza os dados de entrada. O padrão é normalizar.
    
    -mdeg : Ao mostrar o grafo, apenas serão plotados os vértices cujo degree é maior que o especificado. O padrão é 0, ou seja, sem restrições para degree. Tipo int. Exemplo: -mdeg 1
